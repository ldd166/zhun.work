...
MinePlayer.prototype.Go = function(n,t){
	...
	if(pstr == 'dplayer'){
		if(!this.dp){
			...
			mine_dplayerconfig.container = document.getElementById("playleft_"+this.pid);
			mine_dplayerconfig.video = {url:unescape(cur.video)};
			this.dp = new CBPlayer(mine_dplayerconfig);
			this.dp.play();
		}else{
