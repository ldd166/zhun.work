            ...
            <footer class="main-footer footer-type-1 text-xs">
                ...
                <div class="footer-inner">
                    <div class="footer-text">
                        ...
                        ?>
                        <?php else: ?>
                        Copyright © <?php echo date('Y') ?> <?php bloginfo('name'); ?> <?php if(io_get_option('icp')) echo '<a href="http://www.beian.miit.gov.cn/" target="_blank" rel="link noopener">' . io_get_option('icp') . '</a>'?>&nbsp;CC BY-NC-ND 4.0&nbsp;&nbsp;&nbsp;<a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referra" target="_blank" rel="external nofollow"> 感谢 <img src="https://navi.co2.press/wp-content/uploads/2020/05/1590757971_logo5.png" alt="" style="width:50px;height:auto;"> 赞助 </a> 
                        <?php endif; ?>
                    </div>
                </div>
            </footer>
